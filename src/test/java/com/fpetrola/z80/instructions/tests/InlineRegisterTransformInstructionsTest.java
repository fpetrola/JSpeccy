...
public class JSW {
   ...
   public void $0() {
      ...
      do {
         int var11 = this.memory[B_L12];
         int A_L12 = var11 + 1;
         this.memory[1002] = A_L12;
         this.memory[E_L2] = D_L2;
         int H_L16 = H_L5 + 1;
         int D_L15 = D_L2 + 1;
         --B_L12;
      } while(B_L12 != 0);
...
public class JSW {
   ...
   public void $0() {
      ...
      int B_L15;
      do {
         int var10 = this.memory[HL_L11];
         this.memory[DE_L12] = var10;
         ++HL_L11;
         int var12 = DE_L12 >> 8;
         int D_L12 = var12 + 1;
         int var14 = D_L12 << 8;
         int var15 = DE_L12 & 255;
         DE_L12 = var14 | var15;
         B_L15 = B_L10 - 1;
      } while(B_L15 != 0);
...
public class JSW {
   ...
   public void $0() {
      ...
      do {
         ...
         int var9 = IX_L8 + 1;
         this.memory[var9] = A_L8;
         --B_L3;
      } while(B_L3 != 0);

      IX_L8 += 13;
      int var10 = IX_L8 + 1;
      this.memory[var10] = B_L3;
   }
}
""", generateAndDecompile());
  }
