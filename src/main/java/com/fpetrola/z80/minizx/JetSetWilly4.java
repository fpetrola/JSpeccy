...
public class JetSetWilly4 extends MiniZX {
  private static int initialRoom = 32;
      ...
      label216:
      {
        label230:
        {
          ...
          if ((super.A & 128) != 0) {
            label227:
            {
              int var219 = this.mem(34257, 36316);
              super.A = var219;
              if (super.A == 1) {
              ...
              int var220 = this.mem(34255, 36406);
              super.A = var220;
              int var221 = super.A & 14;
              super.A = var221;
              if (super.A == 0) {
                int var243 = this.mem16(34259, 36413);
                this.HL(var243);
                this.DE(64);
                int var244 = this.HL();
                int var245 = this.DE();
                ...
                this.HL(var246);
                if ((super.H & 2) != 0) {
                  int var247 = this.mem(33004, 38098);
                  super.A = var247;
                  this.wMem(33824, super.A, 38101);
                  int var248 = super.A ^ super.A;
                  super.A = var248;
                  super.F = super.A;
                  this.wMem(34255, super.A, 38105);
                  int var249 = this.mem(34257, 38108);
                  super.A = var249;
                  if (super.A < 11) {
                    super.A = 2;
                  ...
                  int var250 = this.mem(34259, 38120);
                  super.A = var250;
                  int var251 = super.A & 31;
                  super.A = var251;
                  super.F = super.A;
              ...
              int var222 = this.mem(34257, 36450);
              super.A = var222;
              if (super.A != 1) {
                this.HL(34256);
                int var223 = this.HL();
                int var224 = this.mem(var223, 36461) & -3;
                int var225 = this.HL();
                this.wMem(var225, var224, 36461);
                int var226 = this.mem(34257, 36463);
                super.A = var226;
                int var227 = super.A | super.A;
                super.A = var227;
                if (super.A == 0) {
                  super.A = 2;
                ...
                super.A = var230;
                int var231 = super.A;
                int var232 = this.rlc(var231);
                super.A = var232;
                int var233 = super.A;
                int var234 = this.rlc(var233);
                super.A = var234;
                int var235 = super.A;
                ...
                super.D = super.A;
                super.C = 32;
                int var237 = this.mem(32990, 36487);
                super.A = var237;

                do {
                  int var238 = super.A ^ 24;
                  super.A = var238;
                  super.F = super.A;
                  super.B = super.D;

                  do {
                    int var239 = super.B - 1 & 255;
                    super.B = var239;
                  } while (super.B != 0);

                  int var240 = super.C - 1 & 255;
                  super.C = var240;
                } while (super.C != 0);

                int var241 = this.mem(34255, 36500);
                super.A = var241;
                int var242 = super.A + 8 & 255;
                super.A = var242;
                super.F = super.A;
          ...
          if ((super.A & 128) != 0) {
            label229:
            {
              int var205 = this.mem(34257, 36574);
              super.A = var205;
              if (super.A >= 12) {
                this.incPops();
              ...
              int var212 = this.mem(32982, 36596);
              super.A = var212;
              int var213 = super.A - 3;
              super.A = var213;
              super.F = super.A;
              super.E = super.A;
            }
          ...
          if (super.A != 0) {
            ...
            super.A = var201;
            int var202 = super.A & 3;
            super.A = var202;
            super.F = super.A;
            int var203 = ~super.A;
            super.A = var203;
            super.F = super.A;
            int var204 = super.A & super.E;
            super.A = var204;
            super.F = super.A;
            super.E = super.A;
          }
          ...
          if (super.A == 31) {
            super.B = 239;
            int var191 = this.BC();
            int var192 = this.in(var191);
            super.A = var192;
            if ((super.A & 1) != 0) {
              int var193 = this.mem(34254, 36736);
              super.A = var193;
              int var194 = super.A | super.A;
              super.A = var194;
              if (super.A == 0) {
                break label230;
              }
          ...
          if ((super.A & 2) == 0) {
            ...
            int var184 = this.mem(34262, 36769);
            super.A = var184;
            ...
            if ((super.A & 128) == 0) {
              ...
              int var186 = this.mem(34255, 36782);
              super.A = var186;
              int var187 = super.A & 240;
              super.A = var187;
              super.F = super.A;
              this.wMem(34255, super.A, 36787);
              this.HL(34256);
              int var188 = this.HL();
              int var189 = this.mem(var188, 36793) | 2;
              int var190 = this.HL();
              this.wMem(var190, var189, 36793);
              return;
            }
          }
        }
        ...
        super.A = var58;
        if (super.A != 0) {
          int var124 = this.mem(34258, 36817);
          super.A = var124;
          int var125 = super.A | super.A;
          super.A = var125;
          if (super.A != 0) {
            int var181 = super.A - 1 & 255;
            super.A = var181;
            super.F = super.A;
          ...
          int var126 = this.mem(34257, 36828);
          super.A = var126;
          this.BC(0);
          if (super.A == 0) {
            int var166 = this.mem16(34259, 36838);
            this.HL(var166);
            this.BC(0);
            int var167 = this.mem(32986, 36844);
            super.A = var167;
            int var168 = super.A - 1 & 255;
            super.A = var168;
            super.F = super.A;
            int var169 = super.A | 161;
            super.A = var169;
            super.F = super.A;
            int var170 = super.A ^ 224;
            super.A = var170;
            super.F = super.A;
            super.E = super.A;
            super.D = 0;
          ...
          int var127 = this.mem16(34259, 36874);
          this.HL(var127);
          super.A = super.L;
          ...
          if (super.A != 0) {
            ...
            super.C = var146;
            int var147 = super.A + super.C & 255;
            super.A = var147;
            super.F = super.A;
            super.B = super.A;
            int var148 = super.A & 15;
            super.A = var148;
            if (super.A != 0) {
              int var154 = this.mem(32946, 36905);
              super.A = var154;
              int var155 = this.HL();
              int var156 = this.DE();
            ...
            this.HL(var152);
            int var153 = this.HL();
            this.wMem16(34259, var153, 36917);
            super.A = super.B;
          ...
          int var129 = this.mem(33001, 38026);
          super.A = var129;
          this.wMem(33824, super.A, 38029);
          int var130 = this.mem(34259, 38032);
          super.A = var130;
          int var131 = super.A | 31;
          super.A = var131;
          super.F = super.A;
          int var132 = super.A & 254;
          super.A = var132;
          super.F = super.A;
        ...
        super.A = var61;
        if (super.A == 0) {
          int var108 = this.mem16(34259, 36951);
          this.HL(var108);
          int var109 = this.mem(32986, 36954);
          super.A = var109;
          int var110 = super.A - 1 & 255;
          super.A = var110;
          super.F = super.A;
          int var111 = super.A | 157;
          super.A = var111;
          super.F = super.A;
          int var112 = super.A ^ 191;
          super.A = var112;
          super.F = super.A;
          super.E = super.A;
          super.D = 0;
