...
//    A = mem(32985, 36240);
  ...
  public void $36307() {
    label216:
    {
        ...
        label228:
        {
          ...
          if ((A & 128) != 0) {
            label227:
            {
              ...
              A = 0;
              wMem(34257, A, 36583);
              int var171 = mem(32973, 36586);
              A = var171;
              int var172 = HL();
              int var173 = mem(var172, 36589);
              if (A != var173) {
                int var176 = HL() + 1 & 65535;
                HL(var176);
                int var177 = HL();
                int var178 = mem(var177, 36593);
                if (A != var178) {
                  break label227;
                }
              }
      ...
      int var65 = mem(33002, 38046);
      A = var65;
      wMem(33824, A, 38049);
      int var66 = mem(34259, 38052);
      A = var66;
      int var67 = A & 224;
      A = var67;
      wMem(34259, A, 38057);
        ...
        if (A != 3) {
          ...
          while (true) {
            label114:
            {
              ...
              if (A << 1 == 0) {
                int var104 = IX() + 5;
                int var105 = mem(var104, 37574);
                A = var105;
                int var106 = HL();
                int var107 = mem(var106, 37577);
                int var108 = A & var107;
                A = var108;
                if (A << 1 == 0) {
                  break label114;
                ...
                int var109 = IX() + 9;
                int var110 = mem(var109, 37580);
                A = var110;
                wMem(34262, A, 37583);
                int var111 = IX() + 11;
                int var112 = mem(var111, 37586) | 1;
                wMem(var111, var112, 37586);
              }

              int var19 = IX() + 9;
              int var20 = mem(var19, 37590);
              if (A == var20) {
                int var94 = IX() + 11;
                if ((mem(var94, 37595) & 1) != 0) {
                  int var95 = IX() + 3;
                  int var96 = mem(var95, 37601);
                  B = var96;
                  int var97 = IX() + 5;
                  int var98 = mem(var97, 37604);
                  A = var98;
                  C = 1;
                  if (A >= 4) {
                    C = 0;
