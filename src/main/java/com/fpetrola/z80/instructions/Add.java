...
public class Add<T extends WordNumber> extends ParameterizedBinaryAluInstruction<T> {
  public Add(OpcodeReference target, ImmutableOpcodeReference source, FlagRegister<T> flag) {
    super(target, source, flag, (tFlagRegister, value, regA) -> TableFlagRegisterInitTables.adc8TableAluOperation.executeWithoutCarry(value, regA, tFlagRegister));
  }
