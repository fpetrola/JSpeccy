...
public class Z80Core implements ICPUData
{
	...
	private final static int		maxAddress					= 65535;
	/* parity lookup table */
	...
	private final static int		regCodeB					= 0x0000;
	private final static int		regCodeC					= 0x0001;
	private final static int		regCodeD					= 0x0002;
	private final static int		regCodeE					= 0x0003;
	...
	private final static int		regCodeBC					= 0x0000;
	private final static int		regCodeDE					= 0x0001;
	private final static int		regCodeHL					= 0x0002;
	// private final static int regCodeIX = 0x0002;
	// private final static int regCodeIY = 0x0002;
	private final static int		regCodeSP					= 0x0003;
	// private final static int regCodeAF = 0x0003;
	/* bit position masks */
	...
	private final static int		flag_5						= 0x0020;
	private final static int		flag_H						= 0x0010;
	private final static int		flag_3						= 0x0008;
	...
	// private final static int msw = 0xFFFF0000;

	private final static byte[]		OPCODE_T_STATES				= new byte[] { 4, 16, 7, 6, 4, 4, 7, 4, 4, 11, 7, 6, 4,
			4, 7, 4, // 0
	...
	private final static byte[]		OPCODE_CB_STATES			= new byte[] { 8, 8, 8, 8, 8, 8, 15, 8, 8, 8, 8, 8, 8,
			8, 15, 8, // 0
	...
	private final static byte[]		OPCODE_DD_FD_STATES			= new byte[] { 0, 0, 0, 0, 0, 0, 0, 0, 0, 15, 0, 0, 0,
			0, 0, 0, // 0
	...
	private final static byte[]		OPCODE_ED_STATES			= new byte[] { 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8, 8,
			8, 8, 8, // 0
	...
	private final static byte[]		OPCODE_INDEXED_CB_STATES	= new byte[] { 0, 0, 0, 0, 0, 0, 23, 0, 0, 0, 0, 0, 0,
			0, 23, 0, // 0
	 ...
	 * 
	 * @param ram
	 *            Interface to the memory architecture
	 * @param io
	 *            Interface to the i/o port architecture
	 */
	 ...
	 * 
	 * @param pc
	 *            Value in the range 0x0000 to 0xFFFF
	 */
	...
	private void decodeOneByteInstruction(int opcode) throws ProcessorException
	{
		...
		switch (opcode)
		{
			...
			{
				dec2SP();
				ram.writeWord(reg_SP, (reg_A << byteSize) | reg_F);
				break;
			}
			case 0xF6:
			{
	...
	private void relativeJump()
	{
		...
		reg_PC++;
		reg_PC = (reg_PC + offset) & maxAddress;
	}
